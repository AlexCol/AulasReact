      ...
      <div className="md:w-980px mx-auto py-8 text-center md:text-current">
        ...
        <div>
          <ul className="hidden md:flex md:flex-wrap text-gray-600 text-sm">
            ...
            <li className="mr-3">
              <a href="#" className="hover:underline">Oculos</a>
            </li>
            <li className="mr-3">
            ...
            <li className="mr-3">
              <a href="#" className="hover:underline">Central de informações de Votação</a>
            </li>
            <li className="mr-3">
              <a href="#" className="hover:underline">Sobre</a>
            </li>
            <li className="mr-3">
              <a href="#" className="hover:underline">Criar anúncios</a>
            </li>
            <li className="mr-3">
